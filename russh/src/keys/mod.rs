...
//!            .unwrap();
//!        crate::keys::agent::server::serve(tokio_stream::wrappers::UnixListenerStream::new(listener), X {}).await
//!    });
...
///
/// ```
/// crate::keys::load_public_key("../files/id_ed25519.pub").unwrap();
/// ```
...
///
/// ```
/// crate::keys::parse_public_key_base64("AAAAC3NzaC1lZDI1NTE5AAAAIJdD7y3aLq454yWBdwLWbieU1ebz9/cu7/QEXn9OIeZJ").is_ok();
/// ```
